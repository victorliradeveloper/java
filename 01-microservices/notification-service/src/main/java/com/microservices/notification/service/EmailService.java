 ...
 *       com backoff exponencial (200ms, 400ms, 800ms). Sucesso eventual = transparente
 *       pro chamador.</li>
 ...
 *   <li><b>CB OPEN → HALF_OPEN → CLOSED</b>: apos o cooldown, CB permite N chamadas
 *       de teste. Se sucedem, CB fecha; se falham, abre de novo.</li>
 * </ul>
 *
 * <h3>Interacao com RabbitMQ</h3>
 * Qualquer excecao ({@link EmailDeliveryException} ou {@code CallNotPermittedException})
 * propaga pro listener; o Spring AMQP retry esgota suas tentativas e a msg cai
 * na DLQ via DLX. Importante: {@code CallNotPermittedException} NAO eh retentavel
 * pelo Resilience4j (so SMTP exceptions reais sao), entao o CB OPEN propaga
 * direto sem retry inutil.
 */
@Slf4j
@Service
