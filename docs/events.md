...
|---------|-----------------|
| `01-microservices/todo-service/.../service/TodoService.java` | Publica os eventos após cada operação |
| `01-microservices/todo-service/.../event/TodoEvent.java` | Define o payload do evento |
| `01-microservices/todo-service/.../config/RabbitMQConfig.java` | Configura exchange, filas, bindings e RabbitTemplate |
| `01-microservices/notification-service/.../listener/TodoEventListener.java` | Consome os eventos |
| `01-microservices/notification-service/.../config/RabbitMQConfig.java` | Espelha a configuração de filas no lado do consumidor |
